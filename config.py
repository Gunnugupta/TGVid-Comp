...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7438164515:AAGZankxbqJLVOfn7fyXHfP_0jQtGI-fDmA") # ⚠️ Required
    FORCE_SUB = os.environ.get('FORCE_SUB', '-1002221767070') # ⚠️ Required
